<template>
  ...
  >
    <template #button>
      <svg viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="h-5 w-5 text-muted-foreground">
    ...
    >
      <div v-show="!isToggleColumnsDisplayed && !isSearchFieldsDisplayed">
        <button
          ...
          class="text-left w-full px-4 py-2 text-sm text-muted-foreground dark:text-gray-200 hover:bg-gray-100 hover:text-gray-900 dark:hover:bg-background hover:text-gray-300 flex gap-2 items-center"
          role="menuitem"
        ...
        <button
          ...
          dusk="reset-button"
          class="text-left w-full px-4 py-2 text-sm text-red-500 hover:bg-gray-100 dark:hover:bg-background hover:text-red-700 flex gap-2 items-center"
          role="menuitem"
      ...
      <div v-show="isSearchFieldsDisplayed">
        ...
        <button
          ...
          class="text-left w-full px-4 py-2 text-sm text-muted-foreground dark:text-gray-200 hover:bg-gray-100 hover:text-gray-900 dark:hover:bg-background hover:text-gray-300"
          role="menuitem"
          ...
          <ul class="divide-y divide-gray-200 dark:divide-border">
            ...
            >
              ...
              <button
                ...
                :class="{
                'bg-primary': !column.hidden,
                'bg-foreground dark:bg-muted': column.hidden,
              }"
              ...
              >
                ...
                <span
                  ...
                  class="inline-block h-5 w-5 rounded-full bg-background dark:bg-background shadow-sm ring-0 transition ease-in-out duration-200"
                />
              </button>
            </li>
          </ul>
